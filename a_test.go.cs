...
namespace Rockyfi
{
    class TestCC
    {
        ...
        void TestAssert_default_values() {
	        ...
	        assertEqual(0, len(root.Children));
	        var nilNode *Node
	        assertEqual(nilNode, root.GetChild(1));
	        assertEqual(nilNode, root.GetChild(0));

	        assertEqual(DirectionInherit, root.Style.Direction);
	        assertEqual(FlexDirection.Column, root.Style.FlexDirection);
	        assertEqual(Justify.FlexStart, root.Style.JustifyContent);
	        assertEqual(Align.FlexStart, root.Style.AlignContent);
	        assertEqual(Align.Stretch, root.Style.AlignItems);
	        assertEqual(Align.Auto, root.Style.AlignSelf);
	        assertEqual(PositionType.Relative, root.Style.PositionType);
	        assertEqual(Wrap.NoWrap, root.Style.FlexWrap);
	        assertEqual(Overflow.Visible, root.Style.Overflow);
	        assertFloatEqual(0, root.StyleGetFlexGrow());
	        assertFloatEqual(0, root.StyleGetFlexShrink());
	        assertEqual(root.Style.FlexBasis.Unit, Unit.Auto);
	        ...
	        assertEqual(DirectionInherit, root.Layout.Direction);
        ...
        void TestAssert_webdefault_values() {
	        ...
	        assertEqual(FlexDirection.Row, root.Style.FlexDirection);
	        assertEqual(Align.Stretch, root.Style.AlignContent);
        ...
        static void newHadOverflowTests() (*Config, *Node) {
        ...
        void TestChildren_overflow_no_wrap_and_no_flex_children() {
	        ...
	        CalculateLayout(root, 200, 100, Direction.LTR);

	        assertTrue(root.Layout.HadOverflow);
        }
        ...
        void TestNo_overflow_no_wrap_and_flex_children() {
	        ...
	        assertFalse(root.Layout.HadOverflow);
        }
        ...
        */
        ...
        void TestCopy_style_modified() {
	        var node0 = Node.CreateDefaultNode();
	        assertFalse(node0.IsDirty);
	        assertEqual(FlexDirection.Column, node0.Style.FlexDirection);
	        ...
	        assertEqual(FlexDirection.Row, node0.Style.FlexDirection);
        ...
        void TestCopy_style_modified_same() {
	        ...
	        CalculateLayout(node0, Undefined, Undefined, Direction.LTR);
	        assertFalse(node0.IsDirty);
